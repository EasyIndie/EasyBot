...
| **Windows U2 升级真机验证** | `docs/other/windows-upgrade-verify.md` | 分离辅助脚本两步替换的运行时锁语义（marker OK/TIMEOUT、`!`/空格路径、回滚拒绝）已通过 Windows 真机 + NSSM 验收（2026-08-14：U1、U2 分离交换机制、场景 C/E/F、A·B 前置路径）；场景 A/B/D/G 完整端到端作为 v0.0.36 发版后回归项 |
