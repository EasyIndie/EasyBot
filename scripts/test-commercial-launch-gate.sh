...
printf '{"passed":true,"backend":"postgres","from_version":"0.0.14","to_version":"0.0.15","duration_ms":1234,"row_counts_verified":true,"rollback_passed":true}\n' > "$TMP/migration.json"
...
printf '{"passed":true,"backend":"sqlite","from_version":"0.0.14","to_version":"0.0.15","duration_ms":1234,"row_counts_verified":true,"rollback_passed":true}\n' > "$TMP/migration.json"
...
printf '{"passed":true,"backend":"postgres","from_version":"0.0.14","to_version":"0.0.15","duration_ms":1234,"row_counts_verified":true,"rollback_passed":false}\n' > "$TMP/migration.json"
...
printf '{"passed":true,"backend":"postgres","from_version":"0.0.14","to_version":"0.0.15","duration_ms":1234,"row_counts_verified":false,"rollback_passed":true}\n' > "$TMP/migration.json"
...
printf '{"metadata":{"passed":true},"backend":"postgres","from_version":"0.0.14","to_version":"0.0.15","duration_ms":1234,"row_counts_verified":true,"rollback_passed":true}\n' > "$TMP/migration.json"
