<h1 align="center">
  <br>
  <img src="assets/EasyBot-Rounded.png" alt="EasyBot Logo" width="200">
  <br>
  EasyBot
  <br>
</h1>
...
详见 [插件快速上手](docs/15 plugin-quickstart.md)、[插件开发完整指南](docs/16 plugin-guide.md) 与 [插件方法论](docs/17 plugin-methodology.md)。
